<template>
  <b-container fluid>
        ...
        <b-form id="qgf" v-show="!hasQuote" class="" method="post">
          ...
          <div class="card border-light mb-5">
                ...
                <b-row class="mt-4 align-items-center">
                  ...
                  <b-col lg="3" sm="4" cols="6">
                    <b-button-group>
                      ...
                      <b-button v-on:click="unsetPostAttached" @click="activeBtn3 = 'btn2'" :class="{active: activeBtn3 === 'btn2' }">Burried</b-button>
                    </b-button-group>
                  </b-col>
                </b-row>
            ...
            <b-row class="fixedSubmit">
              <b-col md="4" sm="12">
                <button type="button" name="button" @click="checkForm(); requestQuote()" class="btn btn-success btn-lg btn-block">Submit
    ...
    <b-row class="fixedSubmit">
      <b-col>
        <a class="btn btn-success btn-lg" href="#">Save Quote</a>
